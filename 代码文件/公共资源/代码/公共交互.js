...
document.addEventListener('DOMContentLoaded', function () {
    ...
    (function aliasRedirect() {
        var path = (document.body.dataset.originalPage || window.location.pathname);
        ...
        if (file === 'eyeball-adventure.html') {
            window.location.replace('../../02-眼球大冒险/代码/眼球大冒险.html' + rest);
            return;
        }
        if (file === 'vision-exploration.html') {
            window.location.replace('../../03-视界探索站/代码/视界探索站.html' + rest);
            return;
        }
    })();
    ...
    (function initDecoderPage() {
        var filename = ((document.body.dataset.originalPage || window.location.pathname).split('/').pop() || '').toLowerCase();
                ...
                $reportWrap.innerHTML =
                    '<div class="decoder-report-wrap">' +
                      '<div class="decoder-report-head">' +
                        '<div class="decoder-report-xgz"><img src="../../公共资源/配图/小光仔全身.png" alt="小光仔"></div>' +
                        '<div>' +
    ...
    (function initAdventurePage() {
        ...
        function openPart(key) {
            ...
            var iconFile = ICON_MAP[key] || '眼球小岛.png';
            modalIcon.innerHTML = '<img class="ad-icon ad-icon--contain" src="../../03-视界探索站/配图/探索素材/' + iconFile + '" alt="' + p.name + '">';
            ...
            modalNext.innerHTML = isLast
                ? '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/奖励宝箱.png" alt="完成"> 完成！去做护眼小挑战 →'
        ...
        function markPartDone(key) {
            ...
            if (state.partsCount < TOTAL_PARTS) {
                bubble.innerHTML =
                    '好棒！又认识了一个新伙伴～<br>还剩 <b>' + (TOTAL_PARTS - state.partsCount) + '</b> 个部位，加油！<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/小星星.png" alt="✨">';
            } else {
                bubble.innerHTML =
                    '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/小光仔开心.png" alt="🎉"> 你已经认识了全部 <b>5 个眼睛小伙伴</b>！<br>点击下方按钮，和我一起进入 <b>护眼知识小挑战</b> 吧～';
            }
            // 解锁下一步
            var btn = $('#advGoQuizBtn');
            if (state.partsCount >= TOTAL_PARTS) {
                btn.disabled = false;
                btn.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/火箭.png" alt="🚀"> 完成结构探索！进入知识小挑战 →';
            }
        }
        ...
        function renderQuiz() {
            ...
            nextBtn.innerHTML = (state.quizIdx === TOTAL_QUIZ - 1)
                ? '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/奖励宝箱.png" alt="🏆"> 查看冒险结果 →'
                : '下一题 →';
        }
        function chooseOption(idx) {
            ...
            if (correct) {
                ...
                inner.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/小星星.png" alt="✨"> <b>' + q.good + '</b>';
                showToast('<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/大星星.png" alt="🌟"> 答对啦，加一颗星星！');
            } else {
                // 正确答案标出绿色
                if (options[q.answer]) options[q.answer].classList.add('correct');
                fb.className = 'quiz-feedback wrong';
                inner.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/苔藓.png" alt="🌱"> <b>' + q.bad + '</b>';
                showToast('<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/播放按钮.png" alt="💡"> 没关系～我们一起学习！');
            }
            ...
            setTimeout(function () {
                ...
                if (state.quizIdx < TOTAL_QUIZ - 1) {
                    guide.innerHTML = correct
                        ...
                        : '这题错啦，不过没关系！<br>小光仔已经告诉你正确答案，再看一遍就记住啦 <img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/小光仔开心.png" alt="😊">';
                } else {
                    guide.innerHTML = '最后一题也做完啦～<br>点 <b><img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/奖励宝箱.png" alt="🏆"> 查看冒险结果 →</b>，看看你的护眼成绩吧！';
                }
        ...
        function finishGame() {
            ...
            if (state.quizStars === TOTAL_QUIZ) {
                sub.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/大星星.png" alt="⭐"> 满分！你已经是一位超级「护眼小专家」啦～';
                showToast('<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/奖励宝箱.png" alt="🏆"> 全对！你真的是护眼小专家～');
            } else if (state.quizStars >= 2) {
                sub.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/小光仔开心.png" alt="👏"> 太棒了！你已经掌握了超多护眼知识，继续加油～';
                showToast('<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/飞船.png" alt="🎉"> 冒险完成，你真优秀！');
            } else {
                sub.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/冰块.png" alt="💪"> 冒险完成！知识需要慢慢记，下次再挑战就能得更多星星啦～';
                showToast('<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/大星星.png" alt="🌟"> 你完成了冒险，真勇敢！');
            }
            goStage(3);
        }
        ...
        function restartAll() {
            ...
            var btn = $('#advGoQuizBtn');
            btn.disabled = true;
            btn.innerHTML = '<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/冰块.png" alt="锁定"> 先完成 5 个部位的探索哦～';
            // 小光仔气泡
            $('#advGuideBubble').innerHTML =
                '嗨！我是小光仔～<br>下面是一只大大的眼睛剖面图！<br>点击 <b>5 个发光小圆圈</b>，让我们从「角膜」开始，一个一个认识它们吧！';
            $('#advQuizGuide').innerHTML =
                '哇～结构探索完成，你真棒！<br>现在来挑战 <b>4 道护眼小题目</b>，答对有星星<img class="ad-icon ad-icon--contain ad-icon--xxs" src="../../03-视界探索站/配图/探索素材/小星星.png" alt="✨">，答错也没关系，我会告诉你答案～';
            // 重新渲染第一题
            renderQuiz();
            // 回到阶段 1
            goStage(1);
    ...
    (function initVisionLab() {
        ...
        if ($rewardHomeBtn) {
            $rewardHomeBtn.addEventListener('click', function () {
                location.href = '../../01-首页/代码/首页.html';
            });
        }
        ...
        function openEyeballLab() {
            openModal(
                ...
                '<div class="vlab-xgz-tip">' +
                  '<div class="vlab-xgz-avatar"><img src="../../公共资源/配图/小光仔全身.png" alt="小光仔"></div>' +
